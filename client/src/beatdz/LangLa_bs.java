...
public class LangLa_bs extends LangLa_fo {
   private mTextBox a;
   private Item b;

   public LangLa_bs(MainScreen var1, Item var2) {
      this.cF = 2;
      this.p = var1;
      this.b = var2;
      this.r = false;
   ...
   public void a(Graphics var1) {
      ...
      mFont.b(mFont.f, var1, Caption.iD, 9, 5 + 15, 0, -1, -16777216);
   ...
   public void a(LangLa_jz var1, int var2, int var3) {
      ...
      case 1003:
         ...
         try {
            Message var7;
            (var7 = new Message((byte)118)).writeShort(var5.b.index);
            var7.writeShort(var5.a.e());
            var7.send();
            return;
